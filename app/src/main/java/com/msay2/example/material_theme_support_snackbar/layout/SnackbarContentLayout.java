package com.msay2.example.material_theme_support_snackbar.layout;
...
import com.msay2.example.material_theme_support_snackbar.widget.BaseTransientBottomBar;
...
public class SnackbarContentLayout extends LinearLayout implements BaseTransientBottomBar.ContentViewCallback 
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) 
	{
        ...
        final int multiLineVPadding = getResources().getDimensionPixelSize(R.dimen.padding_vertical_2lines);
        final int singleLineVPadding = getResources().getDimensionPixelSize(R.dimen.padding_vertical);
