package com.msay2.matarialthemesupportsnackbar;
...
import com.msay2.supportsnackbar.widget.Snackbar;
...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Snackbar.make(root, "Hello !", Snackbar.LENGTH_SHORT).setAction("Above", new View.OnClickListener()
                {
                    @Override
                    public void onClick(View view)
                    {
